...
@objc open class ChartData: NSObject
{
    ...
    @objc open func removeDataSet(_ dataSet: IChartDataSet!) -> Bool
    {
        if dataSet === nil
        {
            return false
    ...
    ///
    /// - returns: `true` if a DataSet was removed, `false` ifno DataSet could be removed.
    @objc open func removeDataSetByIndex(_ index: Int) -> Bool
    {
    ...
    @objc open func removeEntry(_ entry: ChartDataEntry, dataSetIndex: Int) -> Bool
    {
        // entry outofbounds
    ...
    @objc open func removeEntry(xValue: Double, dataSetIndex: Int) -> Bool
    {
        if dataSetIndex >= _dataSets.count
        {
            return false
