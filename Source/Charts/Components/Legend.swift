...
open class Legend: ComponentBase
{
    ...
    /// This property is deprecated - Use `horizontalAlignment`, `verticalAlignment`, `orientation`, `drawInside`, `direction`.
    @available(*, deprecated, message: "Use `horizontalAlignment`, `verticalAlignment`, `orientation`, `drawInside`, `direction`.")
    @objc open var position: Position
    {
        get
        {
    ...
    /// This constructor is deprecated - Use `init(entries:)`
    @available(*, deprecated, message: "Use `init(entries:)`")
    @objc public init(colors: [NSObject], labels: [NSObject])
    {
        super.init()
    ...
    /// This property is deprecated - Use `extraEntries`
    @available(*, deprecated, message: "Use `extraEntries`")
    @objc open var extraColorsObjc: [NSObject]
    {
    ...
    @objc open var extraLabelsObjc: [NSObject]
    {
    ...
    @objc open var colorsObjc: [NSObject]
    {
    ...
    @objc open var labelsObjc: [NSObject]
    {
    ...
    @available(*, deprecated, message: "Use `entries`")
    @objc open func getLabel(_ index: Int) -> String?
    {
    ...
    /// This function is deprecated - Use `Use `setCustom(entries:)`
    @available(*, deprecated, message: "Use `setCustom(entries:)`")
    @objc open func setCustom(colors: [NSObject], labels: [NSObject])
    {
        var entries = [LegendEntry]()
    ...
    /// This function is deprecated - Use `Use `setCustom(entries:)`
    //@available(*, deprecated, message: "Use `setCustom(entries:)`") 
    @objc open func setCustom(colors: [NSObject], labels: [NSObject], forms: [Int])
    {
        var entries = [LegendEntry]()
        ...
        for i in 0 ..< min(colors.count, labels.count)
        {
            ...
            if (forms[i] == 0) {
                entry.form =  Form.none
            } else if (forms[i] == 1) {
                entry.form =  Form.empty
            } else if (forms[i] == 2) {
                entry.form =  Form.default
            } else if (forms[i] == 3) {
                entry.form =  Form.square
            } else if (forms[i] == 4) {
                entry.form =  Form.circle
            } else if (forms[i] == 5) {
                entry.form =  Form.line
            } else if (forms[i] == 6) {
                entry.form =  Form.raincheck
            } else {
                entry.form = Form.circle
            }
