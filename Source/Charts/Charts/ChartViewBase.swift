...
open class ChartViewBase: NSUIView, ChartDataProvider, AnimatorDelegate
{
    ...
    @objc open var descriptionFont: NSUIFont?
    {
    ...
    @objc open var descriptionTextColor: NSUIColor?
    {
    ...
    @objc open var descriptionTextAlign: NSTextAlignment
    {
    ...
    @objc open var chartYMax: Double
    {
        return _data?.yMax ?? 0.0
    }

    /// - returns: The current y-min value across all DataSets
    @objc open var chartYMin: Double
    {
        return _data?.yMin ?? 0.0
    }
    
    @objc open var chartXMax: Double
    {
        return _xAxis._axisMaximum
    }
    
    @objc open var chartXMin: Double
    {
        return _xAxis._axisMinimum
    }
    
    @objc open var xRange: Double
    {
    ...
    @objc open var centerOffsets: CGPoint
    {
